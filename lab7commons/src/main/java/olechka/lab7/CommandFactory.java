...
//        иначе возвращаем просто нихуя)
    ...
    public Optional<String> getCommandName(Class<? extends Command> commandClass) {
//        делаем из map-ы entrySet потому что на мэпе нельзя использовать стримы
        ...
        Optional<String> commandName = listPara.stream().filter((c) -> {
